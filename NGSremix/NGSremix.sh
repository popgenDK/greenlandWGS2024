...
### Step2 run admixture with K=2 to obtain population allele frequency and individual ancestry proportion. As described in relatedAdmix README
### https://github.com/aalbrechtsen/relateAdmix?tab=readme-ov-file#c-from-commandline
...
relatedAdmix -plink ${PLINK_PREFIX} -f ${PLINK_PREFIX}.2.P -q ${PLINK_PREFIX}.2.Q -P 20 -o ${PLINK_PREFIX}.kin
ls -lh ngsremix.res
